...
namespace Director_of_Entry_AND_Exit.Data_Access_Layer
{
    class DAL
    {
        ...
        public DAL()
        {
            //sqlconnection = new SqlConnection(@"Server=.\SQLEXPRESS; Database=Director of Entry AND Exit_DB; integrated security=true");
