...
namespace Director_of_Entry_AND_Exit.Presentation_Layer
{
    public partial class Form_Recovery : Form
    {
        ...
        private void btnReco_Click(object sender, EventArgs e)
        {
            try
            {
                string strQuery = "ALTER Database [Director of Entry AND Exit_DB] SET OFFLINE WITH ROLLBACK IMMEDIATE; Restore Database [Director of Entry AND Exit_DB] From Disk='" + txtFileName.Text + "'";
